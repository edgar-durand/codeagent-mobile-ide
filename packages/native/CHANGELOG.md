...
- Audit improvements — centralize HTML, bridge, store keys, fix bugs

### Chore

- **meta:** Close native UX release task
...
- **native:** Keep ActivityBar visible when side panel collapses
