...
/**
 * Native mirror of the web `useAsyncAdapter`. Keeps an adapter
 * readable from inside effects without making it a dependency, and
 * supplies the reload counter those effects key off.
 *
