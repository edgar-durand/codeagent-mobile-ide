import type { MarketplaceThemeRef } from '@codeam/ide-core';

interface ColorThemeCardProps {
  ref: MarketplaceThemeRef;
  isInstalled: boolean;
  isActive: boolean;
  isBusy: boolean;
  error: string | undefined;
  onInstall: (ref: MarketplaceThemeRef) => void;
  onApply: (ref: MarketplaceThemeRef) => void;
  onUninstall: (ref: MarketplaceThemeRef) => void;
}
